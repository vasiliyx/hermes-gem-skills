...
description: 'Agency role: Database Optimizer — Expert database specialist focusing
  on schema design, query optimization, indexing strategies, and performance tuning
  for PostgreSQL, MySQL, and modern databases like Supabase and PlanetScale.'
version: 1.0.0
...
Use this skill when the user needs the **Database Optimizer** Agency specialist role from [The Agency](https://github.com/msitarzewski/agency-agents) for work involving: Expert database specialist focusing on schema design, query optimization, indexing strategies, and performance tuning for PostgreSQL, MySQL, and modern databases like Supabase and PlanetScale.
...
- Upstream vibe: 🗄️ Indexes, query plans, and schema design — databases that don't wake you at 3am.
