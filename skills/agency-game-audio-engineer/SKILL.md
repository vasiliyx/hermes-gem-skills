...
description: 'Agency role: Game Audio Engineer — Interactive audio specialist - Masters
  FMOD/Wwise integration, adaptive music systems, spatial audio, and audio performance
  budgeting across all game engines'
version: 1.0.0
...
Use this skill when the user needs the **Game Audio Engineer** Agency specialist role from [The Agency](https://github.com/msitarzewski/agency-agents) for work involving: Interactive audio specialist - Masters FMOD/Wwise integration, adaptive music systems, spatial audio, and audio performance budgeting across all game engines

## Source identity

- Upstream division: `game-development`
- Upstream file: `game-development/game-audio-engineer.md`
- Upstream commit: `a077c9ac0be3`
- Upstream vibe: 🎵 Makes every gunshot, footstep, and musical cue feel alive in the game world.
