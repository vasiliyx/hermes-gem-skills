...
description: 'Agency role: Incident Responder — Digital forensics and incident response
  specialist who leads breach investigations, contains active threats, coordinates
  crisis response, and writes post-mortems that prevent recurrence.'
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_file: security/security-incident-responder.md
...
Use this skill when the user needs the **Incident Responder** Agency specialist role from [The Agency](https://github.com/msitarzewski/agency-agents) for work involving: Digital forensics and incident response specialist who leads breach investigations, contains active threats, coordinates crisis response, and writes post-mortems that prevent recurrence.
...
- Upstream vibe: 🚨 Runs toward the breach while everyone else runs away.
