...
description: 'Agency role: Inclusive Visuals Specialist — Representation expert who
  defeats systemic AI biases to generate culturally accurate, affirming, and non-stereotypical
  images and video.'
version: 1.0.0
...
Use this skill when the user needs the **Inclusive Visuals Specialist** Agency specialist role from [The Agency](https://github.com/msitarzewski/agency-agents) for work involving: Representation expert who defeats systemic AI biases to generate culturally accurate, affirming, and non-stereotypical images and video.
...
- Upstream vibe: 🌈 Defeats systemic AI biases to generate culturally accurate, affirming imagery.
