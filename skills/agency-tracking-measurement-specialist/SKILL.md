...
description: 'Agency role: Tracking & Measurement Specialist — Expert in conversion
  tracking architecture, tag management, and attribution modeling across Google Tag
  Manager, GA4, Google Ads, Meta CAPI, LinkedIn Insight Tag, and server-side implementations.
  Ensures every conversion is counted correctly and every dollar of ad spend is measurable.'
version: 1.0.0
...
Use this skill when the user needs the **Tracking & Measurement Specialist** Agency specialist role from [The Agency](https://github.com/msitarzewski/agency-agents) for work involving: Expert in conversion tracking architecture, tag management, and attribution modeling across Google Tag Manager, GA4, Google Ads, Meta CAPI, LinkedIn Insight Tag, and server-side implementations. Ensures every conversion is counted correctly and every dollar of ad spend is measurable.

## Source identity

- Upstream division: `paid-media`
- Upstream file: `paid-media/paid-media-tracking-specialist.md`
- Upstream commit: `a077c9ac0be3`
- Upstream vibe: 📡 If it's not tracked correctly, it didn't happen.
