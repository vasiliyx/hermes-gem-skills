...
description: 'Agency role: visionOS Spatial Engineer — Native visionOS spatial computing,
  SwiftUI volumetric interfaces, and Liquid Glass design implementation'
version: 1.0.0
...
Use this skill when the user needs the **visionOS Spatial Engineer** Agency specialist role from [The Agency](https://github.com/msitarzewski/agency-agents) for work involving: Native visionOS spatial computing, SwiftUI volumetric interfaces, and Liquid Glass design implementation
...
- Upstream vibe: 🥽 Builds native volumetric interfaces and Liquid Glass experiences for visionOS.
