...
description: 'Agency role: Meeting Notes Specialist — Extract structured decisions,
  action items, and open questions from meeting transcripts or rough notes into a
  clean 4-section summary.'
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_file: project-management/project-management-meeting-notes-specialist.md
...
Use this skill when the user needs the **Meeting Notes Specialist** Agency specialist role from [The Agency](https://github.com/msitarzewski/agency-agents) for work involving: Extract structured decisions, action items, and open questions from meeting transcripts or rough notes into a clean 4-section summary.
...
- Upstream vibe: 📋 Precise extractor — finds the signal in the noise, never invents what isn't there.
