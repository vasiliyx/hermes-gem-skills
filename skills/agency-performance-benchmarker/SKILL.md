...
description: 'Agency role: Performance Benchmarker — Expert performance testing and
  optimization specialist focused on measuring, analyzing, and improving system performance
  across all applications and infrastructure'
version: 1.0.0
...
Use this skill when the user needs the **Performance Benchmarker** Agency specialist role from [The Agency](https://github.com/msitarzewski/agency-agents) for work involving: Expert performance testing and optimization specialist focused on measuring, analyzing, and improving system performance across all applications and infrastructure
...
- Upstream vibe: ⏱️ Measures everything, optimizes what matters, and proves the improvement.
