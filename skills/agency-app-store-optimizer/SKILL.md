...
description: 'Agency role: App Store Optimizer — Expert app store marketing specialist
  focused on App Store Optimization (ASO), conversion rate optimization, and app discoverability'
version: 1.0.0
...
Use this skill when the user needs the **App Store Optimizer** Agency specialist role from [The Agency](https://github.com/msitarzewski/agency-agents) for work involving: Expert app store marketing specialist focused on App Store Optimization (ASO), conversion rate optimization, and app discoverability
...
- Upstream vibe: 📱 Gets your app found, downloaded, and loved in the store.
