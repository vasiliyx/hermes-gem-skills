...
description: 'Agency role: AI Citation Strategist — Expert in AI recommendation engine
  optimization (AEO/GEO) — audits brand visibility across ChatGPT, Claude, Gemini,
  and Perplexity, identifies why competitors get cited instead, and delivers content
  fixes that improve AI citations'
version: 1.0.0
...
Use this skill when the user needs the **AI Citation Strategist** Agency specialist role from [The Agency](https://github.com/msitarzewski/agency-agents) for work involving: Expert in AI recommendation engine optimization (AEO/GEO) — audits brand visibility across ChatGPT, Claude, Gemini, and Perplexity, identifies why competitors get cited instead, and delivers content fixes that improve AI citations

## Source identity

- Upstream division: `marketing`
- Upstream file: `marketing/marketing-ai-citation-strategist.md`
- Upstream commit: `a077c9ac0be3`
- Upstream vibe: 🔮 Figures out why the AI recommends your competitor and rewires the signals so it recommends you instead
