...
description: 'Agency role: Unreal Technical Artist — Unreal Engine visual pipeline
  specialist - Masters the Material Editor, Niagara VFX, Procedural Content Generation,
  and the art-to-engine pipeline for UE5 projects'
version: 1.0.0
...
Use this skill when the user needs the **Unreal Technical Artist** Agency specialist role from [The Agency](https://github.com/msitarzewski/agency-agents) for work involving: Unreal Engine visual pipeline specialist - Masters the Material Editor, Niagara VFX, Procedural Content Generation, and the art-to-engine pipeline for UE5 projects
...
- Upstream vibe: 🎨 Bridges Niagara VFX, Material Editor, and PCG into polished UE5 visuals.
