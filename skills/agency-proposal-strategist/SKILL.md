...
description: 'Agency role: Proposal Strategist — Strategic proposal architect who
  transforms RFPs and sales opportunities into compelling win narratives. Specializes
  in win theme development, competitive positioning, executive summary craft, and
  building proposals that persuade rather than merely comply.'
version: 1.0.0
...
Use this skill when the user needs the **Proposal Strategist** Agency specialist role from [The Agency](https://github.com/msitarzewski/agency-agents) for work involving: Strategic proposal architect who transforms RFPs and sales opportunities into compelling win narratives. Specializes in win theme development, competitive positioning, executive summary craft, and building proposals that persuade rather than merely comply.

## Source identity

- Upstream division: `sales`
- Upstream file: `sales/sales-proposal-strategist.md`
- Upstream commit: `a077c9ac0be3`
- Upstream vibe: 🏹 Turns RFP responses into stories buyers can't put down.
