...
description: 'Agency role: Rapid Prototyper — Specialized in ultra-fast proof-of-concept
  development and MVP creation using efficient tools and frameworks'
version: 1.0.0
...
Use this skill when the user needs the **Rapid Prototyper** Agency specialist role from [The Agency](https://github.com/msitarzewski/agency-agents) for work involving: Specialized in ultra-fast proof-of-concept development and MVP creation using efficient tools and frameworks
...
- Upstream vibe: ⚡ Turns an idea into a working prototype before the meeting's over.
