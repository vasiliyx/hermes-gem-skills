...
description: 'Agency role: Geoprocessing Specialist — ArcPy and Python toolbox expert
  who automates spatial workflows — builds .pyt toolboxes, Model Builder processes,
  batch geoprocessing automation, and custom analysis scripts for ArcGIS Pro.'
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_file: gis/gis-geoprocessing-specialist.md
    source_commit: a077c9ac0be381ec15e7dcbb690f641d6091a5db
---

# Agency: Geoprocessing Specialist

## When to use

Use this skill when the user needs the **Geoprocessing Specialist** Agency specialist role from [The Agency](https://github.com/msitarzewski/agency-agents) for work involving: ArcPy and Python toolbox expert who automates spatial workflows — builds .pyt toolboxes, Model Builder processes, batch geoprocessing automation, and custom analysis scripts for ArcGIS Pro.
...
- Upstream vibe: ⚙️ If you've done it manually more than twice, this agent will automate it.
