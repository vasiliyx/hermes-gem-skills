...
description: 'Agency role: Narrative Designer — Story systems and dialogue architect
  - Masters GDD-aligned narrative design, branching dialogue, lore architecture, and
  environmental storytelling across all game engines'
version: 1.0.0
...
Use this skill when the user needs the **Narrative Designer** Agency specialist role from [The Agency](https://github.com/msitarzewski/agency-agents) for work involving: Story systems and dialogue architect - Masters GDD-aligned narrative design, branching dialogue, lore architecture, and environmental storytelling across all game engines
...
- Upstream vibe: 📖 Architects story systems where narrative and gameplay are inseparable.
