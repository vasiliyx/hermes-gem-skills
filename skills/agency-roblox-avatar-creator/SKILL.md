...
description: 'Agency role: Roblox Avatar Creator — Roblox UGC and avatar pipeline
  specialist - Masters Roblox''s avatar system, UGC item creation, accessory rigging,
  texture standards, and the Creator Marketplace submission pipeline'
version: 1.0.0
...
Use this skill when the user needs the **Roblox Avatar Creator** Agency specialist role from [The Agency](https://github.com/msitarzewski/agency-agents) for work involving: Roblox UGC and avatar pipeline specialist - Masters Roblox's avatar system, UGC item creation, accessory rigging, texture standards, and the Creator Marketplace submission pipeline
...
- Upstream vibe: 👤 Masters the UGC pipeline from rigging to Creator Marketplace submission.
