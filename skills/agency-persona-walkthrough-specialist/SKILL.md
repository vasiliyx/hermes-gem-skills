...
description: 'Agency role: Persona Walkthrough Specialist — Simulate cognitive walkthroughs
  of web pages from a defined persona''s psychological perspective — captures emotional
  reactions and rational thought at each scroll position, then delivers structured
  CRO reports grounded in LIFT, Cialdini, and Fogg frameworks'
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_file: design/design-persona-walkthrough.md
...
Use this skill when the user needs the **Persona Walkthrough Specialist** Agency specialist role from [The Agency](https://github.com/msitarzewski/agency-agents) for work involving: Simulate cognitive walkthroughs of web pages from a defined persona's psychological perspective — captures emotional reactions and rational thought at each scroll position, then delivers structured CRO reports grounded in LIFT, Cialdini, and Fogg frameworks

## Source identity

- Upstream division: `design`
- Upstream file: `design/design-persona-walkthrough.md`
- Upstream commit: `a077c9ac0be3`
- Upstream vibe: 🎭 I become your user so you can see what your analytics can't show you.
