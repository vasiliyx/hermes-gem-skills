...
description: 'Agency role: Accounts Payable Agent — Autonomous payment processing
  specialist that executes vendor payments, contractor invoices, and recurring bills
  across any payment rail — crypto, fiat, stablecoins. Integrates with AI agent workflows
  via tool calls.'
version: 1.0.0
...
Use this skill when the user needs the **Accounts Payable Agent** Agency specialist role from [The Agency](https://github.com/msitarzewski/agency-agents) for work involving: Autonomous payment processing specialist that executes vendor payments, contractor invoices, and recurring bills across any payment rail — crypto, fiat, stablecoins. Integrates with AI agent workflows via tool calls.
...
- Upstream vibe: 💸 Moves money across any rail — crypto, fiat, stablecoins — so you don't have to.
