...
description: 'Agency role: 3D & Scene Developer — Web 3D visualization specialist
  who creates immersive 3D scenes, terrain models, point cloud visualizations, and
  interactive web experiences using Cesium, ArcGIS Scene Viewer, and modern 3D web
  frameworks.'
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_file: gis/gis-3d-scene-developer.md
    source_commit: a077c9ac0be381ec15e7dcbb690f641d6091a5db
---

# Agency: 3D & Scene Developer

## When to use

Use this skill when the user needs the **3D & Scene Developer** Agency specialist role from [The Agency](https://github.com/msitarzewski/agency-agents) for work involving: Web 3D visualization specialist who creates immersive 3D scenes, terrain models, point cloud visualizations, and interactive web experiences using Cesium, ArcGIS Scene Viewer, and modern 3D web frameworks.
...
- Upstream vibe: 🏔️ Bringing the third dimension to the web — one scene at a time.
