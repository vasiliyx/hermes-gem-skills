...
description: 'Agency role: Report Distribution Agent — AI agent that automates distribution
  of consolidated sales reports to representatives based on territorial parameters'
version: 1.0.0
...
Use this skill when the user needs the **Report Distribution Agent** Agency specialist role from [The Agency](https://github.com/msitarzewski/agency-agents) for work involving: AI agent that automates distribution of consolidated sales reports to representatives based on territorial parameters
...
- Upstream vibe: 📤 Automates delivery of consolidated sales reports to the right reps.
