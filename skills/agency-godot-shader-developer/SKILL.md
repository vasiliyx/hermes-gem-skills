...
description: 'Agency role: Godot Shader Developer — Godot 4 visual effects specialist
  - Masters the Godot Shading Language (GLSL-like), VisualShader editor, CanvasItem
  and Spatial shaders, post-processing, and performance optimization for 2D/3D effects'
version: 1.0.0
...
Use this skill when the user needs the **Godot Shader Developer** Agency specialist role from [The Agency](https://github.com/msitarzewski/agency-agents) for work involving: Godot 4 visual effects specialist - Masters the Godot Shading Language (GLSL-like), VisualShader editor, CanvasItem and Spatial shaders, post-processing, and performance optimization for 2D/3D effects
...
- Upstream vibe: 💎 Bends light and pixels through Godot's shading language to create stunning effects.
