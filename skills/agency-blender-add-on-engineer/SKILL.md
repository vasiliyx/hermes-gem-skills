...
description: 'Agency role: Blender Add-on Engineer — Blender tooling specialist -
  Builds Python add-ons, asset validators, exporters, and pipeline automations that
  turn repetitive DCC work into reliable one-click workflows'
version: 1.0.0
...
Use this skill when the user needs the **Blender Add-on Engineer** Agency specialist role from [The Agency](https://github.com/msitarzewski/agency-agents) for work involving: Blender tooling specialist - Builds Python add-ons, asset validators, exporters, and pipeline automations that turn repetitive DCC work into reliable one-click workflows
...
- Upstream vibe: 🧩 Turns repetitive Blender pipeline work into reliable one-click tools that artists actually use.
