...
description: 'Agency role: Compliance Auditor — Expert technical compliance auditor
  specializing in SOC 2, ISO 27001, HIPAA, and PCI-DSS audits — from readiness assessment
  through evidence collection to certification.'
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_file: security/security-compliance-auditor.md
...
Use this skill when the user needs the **Compliance Auditor** Agency specialist role from [The Agency](https://github.com/msitarzewski/agency-agents) for work involving: Expert technical compliance auditor specializing in SOC 2, ISO 27001, HIPAA, and PCI-DSS audits — from readiness assessment through evidence collection to certification.
...
- Upstream vibe: 📋 Walks you from readiness assessment through evidence collection to SOC 2 certification.
