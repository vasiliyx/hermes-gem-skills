...
description: 'Agency role: GeoAI/ML Engineer — Geospatial machine learning specialist
  who builds models for feature extraction, object detection, image segmentation,
  and land cover classification from satellite and aerial imagery.'
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_file: gis/gis-geoai-ml-engineer.md
...
Use this skill when the user needs the **GeoAI/ML Engineer** Agency specialist role from [The Agency](https://github.com/msitarzewski/agency-agents) for work involving: Geospatial machine learning specialist who builds models for feature extraction, object detection, image segmentation, and land cover classification from satellite and aerial imagery.
...
- Upstream vibe: 🤖 Teaching machines to see the Earth — one pixel at a time.
