...
description: 'Agency role: Sales Data Extraction Agent — AI agent specialized in monitoring
  Excel files and extracting key sales metrics (MTD, YTD, Year End) for internal live
  reporting'
version: 1.0.0
...
Use this skill when the user needs the **Sales Data Extraction Agent** Agency specialist role from [The Agency](https://github.com/msitarzewski/agency-agents) for work involving: AI agent specialized in monitoring Excel files and extracting key sales metrics (MTD, YTD, Year End) for internal live reporting
...
- Upstream vibe: 📊 Watches your Excel files and extracts the metrics that matter.
