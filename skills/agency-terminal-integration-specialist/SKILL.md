...
description: 'Agency role: Terminal Integration Specialist — Terminal emulation, text
  rendering optimization, and SwiftTerm integration for modern Swift applications'
version: 1.0.0
...
Use this skill when the user needs the **Terminal Integration Specialist** Agency specialist role from [The Agency](https://github.com/msitarzewski/agency-agents) for work involving: Terminal emulation, text rendering optimization, and SwiftTerm integration for modern Swift applications

## Source identity

- Upstream division: `spatial-computing`
- Upstream file: `spatial-computing/terminal-integration-specialist.md`
- Upstream commit: `a077c9ac0be3`
- Upstream vibe: 🖥️ Masters terminal emulation and text rendering in modern Swift applications.
