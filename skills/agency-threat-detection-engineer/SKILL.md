...
description: 'Agency role: Threat Detection Engineer — Expert detection engineer specializing
  in SIEM rule development, MITRE ATT&CK coverage mapping, threat hunting, alert tuning,
  and detection-as-code pipelines for security operations teams.'
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_file: security/security-threat-detection-engineer.md
...
Use this skill when the user needs the **Threat Detection Engineer** Agency specialist role from [The Agency](https://github.com/msitarzewski/agency-agents) for work involving: Expert detection engineer specializing in SIEM rule development, MITRE ATT&CK coverage mapping, threat hunting, alert tuning, and detection-as-code pipelines for security operations teams.
...
- Upstream vibe: 🎯 Builds the detection layer that catches attackers after they bypass prevention.
