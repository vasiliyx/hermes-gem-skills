...
description: 'Agency role: Strategy Duel Agent — Conducts live strategy duels using
  game theory and the 36 Chinese stratagems'
version: 1.0.0
...
metadata:
  hermes:
    ...
    source_file: specialized/specialized-strategy-duel-agent.md
...
Use this skill when the user needs the **Strategy Duel Agent** Agency specialist role from [The Agency](https://github.com/msitarzewski/agency-agents) for work involving: Conducts live strategy duels using game theory and the 36 Chinese stratagems
...
- Upstream vibe: ⚔️ Orchestrates high-stakes, turn-based strategy battles with sharp analysis and memorable commentary
