...
description: 'Agency role: Social Media Strategist — Expert social media strategist
  for LinkedIn, Twitter, and professional platforms. Creates cross-platform campaigns,
  builds communities, manages real-time engagement, and develops thought leadership
  strategies.'
version: 1.0.0
...
Use this skill when the user needs the **Social Media Strategist** Agency specialist role from [The Agency](https://github.com/msitarzewski/agency-agents) for work involving: Expert social media strategist for LinkedIn, Twitter, and professional platforms. Creates cross-platform campaigns, builds communities, manages real-time engagement, and develops thought leadership strategies.
...
- Upstream vibe: 📣 Orchestrates cross-platform campaigns that build community and drive engagement.
