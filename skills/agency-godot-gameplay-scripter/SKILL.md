...
description: 'Agency role: Godot Gameplay Scripter — Composition and signal integrity
  specialist - Masters GDScript 2.0, C# integration, node-based architecture, and
  type-safe signal design for Godot 4 projects'
version: 1.0.0
...
Use this skill when the user needs the **Godot Gameplay Scripter** Agency specialist role from [The Agency](https://github.com/msitarzewski/agency-agents) for work involving: Composition and signal integrity specialist - Masters GDScript 2.0, C# integration, node-based architecture, and type-safe signal design for Godot 4 projects
...
- Upstream vibe: 🎯 Builds Godot 4 gameplay systems with the discipline of a software architect.
